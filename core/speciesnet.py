...
from tools.regenerate_image_embeddings import regenerate_image_embeddings_and_score
...
def run_speciesnet(update_status=None):
    ...
    """
    jpeg_files = list(STAGE_PROCESSED_DIR.glob("*.jpg"))
    if not jpeg_files:
        if update_status:
    ...
    if process.returncode == 0:
        ...
        regenerate_image_embeddings_and_score(only_current_batch=True)
